...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "flex h-14 items-center gap-1 border-b bg-background px-4",
        className,
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        // layout
        "relative flex items-center rounded-sm px-3 py-2 text-sm font-medium outline-hidden select-none",

        // shadcn focus/open styles
        "focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground",

        // BBC-ish underline animation
        "after:absolute after:left-2 after:right-2 after:-bottom-[2px] after:h-[2px] after:origin-left after:scale-x-0 after:rounded-full after:bg-[var(--color-soft-amber)] after:transition-transform after:duration-200",
